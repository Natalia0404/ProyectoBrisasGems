...
-- Incluye la mejora B: val_imagen
...
create table portafolio_inspiracion (
    ...
    por_imagen       varchar(250) not null, -- imagen de inspiración
    por_video        varchar(250),          -- URL o nombre del video (opcional)
