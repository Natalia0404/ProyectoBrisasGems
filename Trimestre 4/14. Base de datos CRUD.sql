...
-- 1. Actualizar el estado del pedido a "tallado" (est_id = 2)
update pedido
set est_id = 2
where ped_id = 101;

-- 2. Actualizar el nombre de un valor de personalización
update valor_personalizacion
set val_nombre = 'Zafiro azul oscuro'
where val_id = 4;

-- 3. Corregir número telefónico de un cliente
update usuarios
set usu_telefono = '3159876543'
where usu_id = 2001;

-- 4. Cambiar el nombre de una opción de personalización para mayor claridad
update opcion_personalizacion
set opc_nombre = 'Material del engaste'
where opc_id = 2;

-- 5. Agregar un comentario en un pedido luego de revisar el diseño
update pedido
set ped_comentarios = 'Diseño aprobado por el cliente. Iniciar tallado.'
where ped_id = 101;

-- ================================
-- ELIMINACIONES DE DATOS RELEVANTES
-- ================================

-- 1. Eliminar un valor de personalización que fue creado por error
delete from valor_personalizacion
where val_id = 12;

-- 2. Eliminar una opción de personalización obsoleta
delete from opcion_personalizacion
where opc_id = 5;

-- 3. Eliminar un render 3D rechazado
delete from render_3d
where ren_id = 8;

-- 4. Eliminar una foto final que fue subida con errores
delete from foto_producto_final
where fot_id = 6;

-- 5. Eliminar un estado de pedido que no se usa en el flujo actual
